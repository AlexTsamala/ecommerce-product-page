...
const CartContainer = (props) => {
    return ( 
        <div className=" bg-white absolute w-cartWidth left-cartLeft h-64 desktop:w-84" style={{left:"3%",borderRadius:"10px",boxShadow:"0px 20px 50px -20px rgb(29 32 38 / 50%)",top:"100px"}}>
