const ShoesQuantity = (props) => {
    return (  
        <div className="h-14 flex justify-between items-center bg-slate-50 p-6 rounded-xl cursor-pointer desktop:w-40 desktop:h-14">
            <svg onClick={props.shoesQuantityHandlerMinus} width="12" height="4" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"><defs><path d="M11.357 3.332A.641.641 0 0 0 12 2.69V.643A.641.641 0 0 0 11.357 0H.643A.641.641 0 0 0 0 .643v2.046c0 .357.287.643.643.643h10.714Z" id="a"/></defs><use fill="#FF7E1B" fillRule="nonzero" xlinkHref="#a"/></svg>
            <span className=" text-neutral-800 font-bold text-base">{props.shoesQuantity}</span>
            <svg onClick={props.shoesQuantityHandler} width="12" height="12" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"><defs>
