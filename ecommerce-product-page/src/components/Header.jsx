        ...
        <div className=" mr-6 ml-6 mt-5 desktop:flex desktop:justify-between desktop:flex-col desktop:gap-12 desktop:mr-40 desktop:ml-40 desktop:mt-7">
            <div className="flex justify-between">
                ...
                <div className="flex items-center gap-5.5 ">
                    {props.addToCart > 0 ? <div className="flex justify-center items-center text-white  bg-orange-500 rounded-full" style={{transform:"translate(50px, -10px)", height:"13px", width:"19px",fontSize:"10px"}}>{props.addToCart}</div> : ""}
