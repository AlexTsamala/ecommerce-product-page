...
const Header = () => {
    ...
    return (
        <div className="flex justify-between mr-6 ml-6 mt-5">
            <div className="flex items-center gap-4">
                <svg onClick={controlMenu} className="cursor-pointer" width="16" height="15" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="flex items-center gap-5.5 ">
                ...
                <div className="rounded-full flex justify-center items-center w-7 h-7 hover:bg-orange-500">
                    <img className="h-6 w-6 cursor-pointer" alt="user-img" src={UserImage}/>
                </div>
            </div>
            { handleMenu && <MobileMenu controlMenu={controlMenu}/>}
            { handleCart && <CartContainer/>}
        </div>
      );
}
